...
var doc = `{
  ...
  "tags": [
    ...
    {
      "name": "Positions",
      "description": "The positions API provides information about an account’s current open positions."
    },
    {
      "name": "Account",
  ...
  "paths": {
    ...
    "/verification/{otp}": {
			"get": {
				...
				"description": "It'll very the OTP and make user verified",
				"summary": "Verify OTP",
				"produces": [
					"application/json"
				],
    ...
    "/v1/terms-condition": {
      "get": {
        ...
        "description": "Get HTML Page of Terms & Conditions",
		...
		"/recover-password": {
            ...
            "description": "Fill recover password data.",
            "schema": {
              "type": "object",
              "required": [
                "email",
    ...
    "/v1/users/post/private":{
      "get":{
        "tags":[
          "Users"
        ],
        "description": "List private posts",
    ...
    "AssetsResponse": {
      ...
      "items": {
        "properties": {
					"id": {
						"type": "string",
						"example": "f30d734c-2806-4d0d-b145-f9fade61432b"
					},
					"class": {
						"type": "string",
						"example": "us_equity"
					...
					"name": {
						"type": "string",
						"example": "Alphabet Inc. Class C Capital Stock"
					},
					"status": {
						"type": "string",
						"example": "active"
						...
						"properties": {
							...
							"latestQuote": {
								...
								"properties": {
									...
									"t": {
										"type": "string",
										"example": "2021-07-02T19:59:52.071783881Z"
									}
								}
							},
							"latestTrade": {
								...
								"properties": {
									...
									"t": {
										"type": "string",
										"example": "2021-07-02T19:59:50.245475149Z"
									},
									"x": {
										"type": "string",
										"example": "V"
